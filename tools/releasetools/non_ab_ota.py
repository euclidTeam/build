...
""" % bcb_dev)
  ...
  script.Print("====================================================");
  script.Print("                         __ _      __  ____  _____  ");
  script.Print("     ___   __  __ _____ / /(_)____/ / / __ \/ ___/  ");
  script.Print("    / _ \ / / / // ___// // // __  / / / / /\__ \   ");
  script.Print("   /  __// /_/ // /__ / // // /_/ / / /_/ /___/ /   ");
  script.Print("   \___/ \__,_/ \___//_//_/ \__,_/  \____//____/    ");
  script.Print("                                                    ");
  script.Print("====================================================");
  script.Print("====================================================");
